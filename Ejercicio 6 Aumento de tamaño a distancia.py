...
xmaxima = 800    #ancho de la pantalla
ymaxima = 700     #alto de la pantalla
...
def main():  #declaracion de colores
    ...
    delta = 10 # paso
    cuantos = 70 # numero de particulas
    tope = 30 # tope maximo para que cambie su color 
    ...
    while not exitflag:
        ...
        for pi in range(cuantos - 1): # 2 tipos de particulas iniciales p1 y p2 
            ...
            for pj in range(pi + 1, cuantos):
                p2 = particulas[pi]# comparacion de una particula con otra segun la distancia que tengan 
        ...
        for pos in range(cuantos):# posicion de particula dependiendo de la cantidad de particulas 
            ...
            pygame.draw.circle(screen, color, (p.x, p.y), aux)
                       
        pygame.display.flip()
        clock.tick(20) #Ajuste del tiempo
    pygame.quit()
